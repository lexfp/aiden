...
class LootSystem {
  ...
  _spawnChest() {
    ...
    const geo = new THREE.BoxGeometry(0.9, 0.7, 0.6);
    const mat = new THREE.MeshLambertMaterial({ color: 0xf0c050 });
    const mesh = new THREE.Mesh(geo, mat);
    mesh.position.set(sp.x, y + 0.35, sp.z);
    ...
    mesh.userData.type = 'chest';
    this.scene.add(mesh);
    this.items.push({ mesh, type: 'chest', item: null, opened: false, ring });
  }
