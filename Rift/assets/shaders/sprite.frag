...
// crush the atlas/palette coordinate precision and collapse the world to grey.
...
void main() {
    ...
    if (palette_index.g > .5) {  // Transparent pixel.
        ...
        // Palette has no mipmaps (uniforms.rs), so this dependent lookup can't
        // sample an averaged (grey) mip level.
